...
(function () {
  ...
  const ICONS = {
    ...
    'ecosystem-puzzle': { c: 'c2', d: '<rect x="3" y="3" width="18" height="18" rx="2.6"/><path d="M12 18.2v-4.9"/><path d="M12 13.3c0-2.3-1.9-4.2-4.2-4.2 0 2.3 1.9 4.2 4.2 4.2Z"/><path d="M12 13.3c0-1.9 1.6-3.5 3.5-3.5 0 1.9-1.6 3.5-3.5 3.5Z"/>' },
    ...
    'rate-pocket': { c: 'c1', d: '<circle cx="5.6" cy="12" r="3.2"/><circle cx="18.4" cy="12" r="3.2"/><path d="M9.6 9.6h4.2"/><path d="m12.5 8.3 1.3 1.3-1.3 1.3"/><path d="M14.4 14.4h-4.2"/><path d="m11.5 13.1-1.3 1.3 1.3 1.3"/>' },
