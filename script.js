...
const STRINGS = {
  en: {
    ...
    // ランディング（トップの上半分）
    lpBrowHero: 'Small problems, small apps',
    lpTitleA: 'Share a small problem.',
    lpTitleB: 'Get a small app.',
    ...
    lpFactOffline: 'Keeps working offline',
    lpFactSource: 'Every line of source is public',
    lpBrowGap: 'The gap',
    lpGapTitle: 'Too small for an app. Too annoying to ignore.',
    lpGapLead: 'Nobody ships a product for this. So someone here builds a tiny one instead, and leaves it on the shelf for you.',
    lpQuote1: '“I forget the same thing every single trip.”',
    lpQuote2: '“I never notice the shampoo is out until it’s out.”',
    lpQuote3: '“I lose the reading streak the moment I stop counting.”',
    lpBrowHow: 'How it works',
    lpHowTitle: 'Three steps, one shelf.',
    lpHowLead: 'Step 1 and 2 need a Google sign-in. Step 3 never does.',
    lpStep1Title: 'Post the problem',
    lpStep1Desc: 'Plain words, one sentence. No spec needed.',
    lpStep2Title: 'Someone builds it',
    lpStep2Desc: 'A maker takes it off the board and ships it.',
    lpStep3Title: 'It lands on the shelf',
    lpStep3Desc: 'Free for everyone, from then on.',
    lpBrowWhy: 'Why it feels light',
    lpWhyTitle: 'Nothing to set up. Nothing to lose.',
    lpFeat1Title: 'Opens in the browser',
    lpFeat1Desc: 'No install, no app store. Once it has loaded, every app keeps working with the wifi off.',
    lpFeat2Title: 'Your data stays on your device',
    lpFeat2Desc: 'Saved in your own browser. Sign in only if you want the same list on your phone too.',
    lpFeat3Title: 'One request, one app',
    lpFeat3Desc: 'Nothing here was built on a hunch. Every app exists because somebody asked for it.',
    lpFeat4Title: 'Real accounts behind every post',
    lpFeat4Desc: 'Requests, ratings and comments need a Google sign-in. That is what keeps the board free of junk and anonymous abuse.',
    lpBrowShelf: 'On the shelf',
    lpShelfTitle: 'Pick one up. It opens straight away.',
    lpBrowseAll: 'Browse all {count}',
    lpBrowOpen: 'Open right now',
    lpOpenTitle: 'Nobody has built these yet.',
    lpOpenLead: 'Requests sitting on the board today. Any of them is an evening’s work.',
    lpBuildThis: 'I’ll build this',
    lpOpenFine: 'Claiming a request signs you in with Google, so the person who asked knows who picked it up.',
    lpBrowFaq: 'Before you ask',
    lpFaqTitle: 'The four questions everyone has.',
    lpFaq1Q: 'Is it actually free?',
    lpFaq1A: 'Yes. There is no paid tier, no trial, and no plan to add one.',
    lpFaq2Q: 'Do I need an account?',
    lpFaq2A: 'Not to browse, and not to use any of the apps. Posting a request, rating an app, leaving a comment or claiming a build signs you in with Google — an anonymous board fills up with abuse, and a name next to a post stops that.',
    lpFaq3Q: 'Where does my data go?',
    lpFaq3A: 'Into your own browser. Nothing leaves your device unless you sign in and ask for it on a second device.',
    lpFaq4Q: 'Can I build one?',
    lpFaq4A: 'Yes — that is the point. Take a request off the board, ship a small app, put it on the shelf.',
    lpBrowTwoWays: 'Two ways in',
    lpFinalTitle: 'It starts with something small that annoys you.',
    lpFinalLead: 'Whichever side of it you are on, the first move is the same.',
    lpLane1Title: 'Got a problem?',
    lpLane1Desc: 'Write it in one sentence and leave it on the board.',
    lpLane1Cta: 'Post a problem',
    lpLane2Title: 'Got a free evening?',
    lpLane2Desc: 'Take a request off the board and build it.',
    lpLane2Cta: 'See open requests',
    lpFinalFine: 'Both take a Google sign-in. Nothing else is asked of you.',
    lpRailText: 'The board',
    title: 'CobbleWorks',
    ...
    emailNotifyLabel: 'Email me when my request becomes an app',
    emailNotifyNote: 'Sent to your Google account address. Your Inbox here keeps working either way.',
    save: 'Save',
    cancel: 'Cancel',
  ...
  ja: {
    ...
    lpFactOffline: '通信を切っても動き続ける',
    lpFactSource: 'ソースコードは全部公開',
    lpBrowGap: 'すき間',
    lpGapTitle: 'アプリにするには小さすぎる。放っておくには面倒すぎる。',
    lpGapLead: '誰もこのために製品は作りません。だからここでは、誰かが小さなものを作って、棚に置いていきます。',
    lpQuote1: '「毎回おなじものを忘れる」',
    lpQuote2: '「シャンプーが切れるまで気づかない」',
    lpQuote3: '「数えるのをやめた瞬間に、読書の連続記録が途切れる」',
    lpBrowHow: '使い方',
    lpHowTitle: '3つのステップ、ひとつの棚。',
    lpHowLead: '1と2はGoogleログインが必要です。3はいつでも要りません。',
    lpStep1Title: '困りごとを書く',
    lpStep1Desc: 'ふつうの言葉で一文だけ。仕様書は要りません。',
    lpStep2Title: '誰かが作る',
    lpStep2Desc: '作る人が掲示板から拾って、形にします。',
    lpStep3Title: '棚に並ぶ',
    lpStep3Desc: 'そこから先は、誰でも無料で使えます。',
    lpBrowWhy: '身軽さの理由',
    lpWhyTitle: '準備も要らない。失うものもない。',
    lpFeat1Title: 'ブラウザで開くだけ',
    lpFeat1Desc: 'インストールもアプリストアも不要。一度読み込めば、通信を切っても動き続けます。',
    lpFeat2Title: 'データは手元に残る',
    lpFeat2Desc: '保存先は自分のブラウザの中。スマホでも同じものを見たいときだけログインしてください。',
    lpFeat3Title: '1つの困りごとに、1つのアプリ',
    lpFeat3Desc: '思いつきで作られたものはありません。どれも誰かが「ほしい」と言ったから存在します。',
    lpFeat4Title: '投稿には必ず名前がある',
    lpFeat4Desc: 'リクエスト・評価・コメントにはGoogleログインが必要です。匿名で荒らされないための仕組みです。',
    lpBrowShelf: '棚のなかみ',
    lpShelfTitle: 'ひとつ手に取ってみてください。すぐ開きます。',
    lpBrowseAll: '{count}個ぜんぶ見る',
    lpBrowOpen: 'いま募集中',
    lpOpenTitle: 'まだ誰も作っていません。',
    lpOpenLead: '今日、掲示板に置かれている困りごとです。どれも一晩あれば作れます。',
    lpBuildThis: '作ってみる',
    lpOpenFine: '「作ってみる」を押すとGoogleログインになります。書いた人に、誰が引き受けたか分かるようにするためです。',
    lpBrowFaq: '聞かれる前に',
    lpFaqTitle: 'みんなが気になる4つのこと。',
    lpFaq1Q: '本当に無料ですか？',
    lpFaq1A: 'はい。有料プランも体験版もありませんし、これから作る予定もありません。',
    lpFaq2Q: 'アカウントは必要ですか？',
    lpFaq2A: '見るだけ・使うだけなら要りません。リクエストの投稿、アプリの評価、コメント、制作の宣言をするときだけGoogleログインになります。匿名の掲示板は荒れてしまうので、投稿に名前が残るようにしています。',
    lpFaq3Q: '書いたデータはどこへ行きますか？',
    lpFaq3A: '自分のブラウザの中です。ログインして別の端末でも見たいと言わない限り、データが端末の外に出ることはありません。',
    lpFaq4Q: '自分でも作れますか？',
    lpFaq4A: 'はい、それがこの場所の目的です。掲示板から困りごとをひとつ選んで、小さなアプリを作って、棚に置いてください。',
    lpBrowTwoWays: '入り口は2つ',
    lpFinalTitle: '始まりはいつも、ちょっとした面倒ごとです。',
    lpFinalLead: 'どちら側の人でも、最初の一歩は同じです。',
    lpLane1Title: '困っていることがある',
    lpLane1Desc: '一文で書いて、掲示板に置いてください。',
    lpLane1Cta: '困りごとを書く',
    lpLane2Title: '夜が少し空いている',
    lpLane2Desc: '掲示板から困りごとをひとつ引き受けて、作ってください。',
    lpLane2Cta: '募集中の困りごとを見る',
    lpFinalFine: 'どちらもGoogleログインだけ。ほかに求めるものはありません。',
    lpRailText: '掲示板へ',
    title: 'CobbleWorks',
    ...
    emailNotifyLabel: 'リクエストがアプリになったらメールで知らせる',
    emailNotifyNote: 'Googleアカウントのメールアドレス宛に届きます。オフにしてもInboxには残ります。',
    save: '保存',
    cancel: 'キャンセル',
  ...
  es: {
    ...
    // ランディング（トップの上半分）
    lpBrowHero: 'Problemas pequeños, apps pequeñas',
    lpTitleA: 'Cuenta un problema pequeño.',
    lpTitleB: 'Recibe una app pequeña.',
    ...
    lpFactOffline: 'Sigue funcionando sin conexión',
    lpFactSource: 'Todo el código es público',
    lpBrowGap: 'El hueco',
    lpGapTitle: 'Demasiado pequeño para una app. Demasiado molesto para ignorarlo.',
    lpGapLead: 'Nadie lanza un producto para esto. Así que aquí alguien construye algo diminuto y lo deja en el estante para ti.',
    lpQuote1: '«Olvido lo mismo en cada viaje.»',
    lpQuote2: '«Nunca me doy cuenta de que se acabó el champú hasta que se acaba.»',
    lpQuote3: '«Pierdo la racha de lectura en cuanto dejo de contarla.»',
    lpBrowHow: 'Cómo funciona',
    lpHowTitle: 'Tres pasos, un estante.',
    lpHowLead: 'Los pasos 1 y 2 necesitan entrar con Google. El paso 3 nunca.',
    lpStep1Title: 'Cuenta el problema',
    lpStep1Desc: 'En palabras normales, una frase. No hace falta ninguna especificación.',
    lpStep2Title: 'Alguien lo construye',
    lpStep2Desc: 'Alguien lo toma del tablón y lo publica.',
    lpStep3Title: 'Llega al estante',
    lpStep3Desc: 'Gratis para todo el mundo, desde ese momento.',
    lpBrowWhy: 'Por qué resulta tan ligero',
    lpWhyTitle: 'Nada que configurar. Nada que perder.',
    lpFeat1Title: 'Se abre en el navegador',
    lpFeat1Desc: 'Sin instalación ni tienda de apps. Una vez cargada, cada app sigue funcionando con el wifi apagado.',
    lpFeat2Title: 'Tus datos se quedan en tu dispositivo',
    lpFeat2Desc: 'Se guardan en tu propio navegador. Entra solo si quieres la misma lista también en el móvil.',
    lpFeat3Title: 'Una petición, una app',
    lpFeat3Desc: 'Aquí nada se hizo por corazonada. Cada app existe porque alguien la pidió.',
    lpFeat4Title: 'Detrás de cada publicación hay una cuenta real',
    lpFeat4Desc: 'Las peticiones, las valoraciones y los comentarios necesitan entrar con Google. Eso es lo que mantiene el tablón libre de basura y de abusos anónimos.',
    lpBrowShelf: 'En el estante',
    lpShelfTitle: 'Coge una. Se abre al momento.',
    lpBrowseAll: 'Ver las {count}',
    lpBrowOpen: 'Abiertas ahora mismo',
    lpOpenTitle: 'Nadie ha construido estas todavía.',
    lpOpenLead: 'Peticiones que hoy están en el tablón. Cualquiera de ellas es el trabajo de una tarde.',
    lpBuildThis: 'Yo la construyo',
    lpOpenFine: 'Reservar una petición te hace entrar con Google, para que quien la escribió sepa quién la ha tomado.',
    lpBrowFaq: 'Antes de que preguntes',
    lpFaqTitle: 'Las cuatro preguntas de siempre.',
    lpFaq1Q: '¿De verdad es gratis?',
    lpFaq1A: 'Sí. No hay plan de pago, ni prueba, ni intención de añadirlos.',
    lpFaq2Q: '¿Necesito una cuenta?',
    lpFaq2A: 'No para mirar, ni para usar ninguna de las apps. Publicar una petición, valorar una app, dejar un comentario o reservar un encargo te hace entrar con Google: un tablón anónimo se llena de abusos, y un nombre junto a cada mensaje lo evita.',
    lpFaq3Q: '¿Adónde van mis datos?',
    lpFaq3A: 'A tu propio navegador. Nada sale de tu dispositivo salvo que entres y pidas tenerlo en un segundo dispositivo.',
    lpFaq4Q: '¿Puedo construir una?',
    lpFaq4A: 'Sí, de eso se trata. Coge una petición del tablón, publica una app pequeña y déjala en el estante.',
    lpBrowTwoWays: 'Dos formas de entrar',
    lpFinalTitle: 'Todo empieza con algo pequeño que te molesta.',
    lpFinalLead: 'Estés del lado que estés, el primer paso es el mismo.',
    lpLane1Title: '¿Tienes un problema?',
    lpLane1Desc: 'Escríbelo en una frase y déjalo en el tablón.',
    lpLane1Cta: 'Publicar un problema',
    lpLane2Title: '¿Tienes una tarde libre?',
    lpLane2Desc: 'Coge una petición del tablón y constrúyela.',
    lpLane2Cta: 'Ver peticiones abiertas',
    lpFinalFine: 'Las dos cosas solo piden entrar con Google. Nada más.',
    lpRailText: 'El tablón',
    title: 'CobbleWorks',
    ...
    emailNotifyLabel: 'Avísame por correo cuando mi petición se convierta en app',
    emailNotifyNote: 'Se envía a la dirección de tu cuenta de Google. Tu Inbox aquí sigue funcionando igual.',
    save: 'Guardar',
    cancel: 'Cancelar',
  ...
  zh: {
    ...
    lpFactInstall: '无需安装',
    lpFactOffline: '断网也能继续用',
    lpFactSource: '每一行源码都公开',
    lpBrowGap: '空着的地方',
    lpGapTitle: '做成产品太小，放着不管又太烦。',
    lpGapLead: '没有人会为这种事做产品。所以在这里，有人做了个很小的，放到架子上给你用。',
    lpQuote1: '「每次出门都会忘记同一样东西。」',
    lpQuote2: '「洗发水用完了才发现没了。」',
    lpQuote3: '「一不数，读书的连续记录就断了。」',
    lpBrowHow: '怎么运作',
    lpHowTitle: '三步，一个架子。',
    lpHowLead: '第 1 步和第 2 步需要用 Google 登录，第 3 步永远不用。',
    lpStep1Title: '写下麻烦',
    lpStep1Desc: '用平常的话写一句就行，不用写规格。',
    lpStep2Title: '有人来做',
    lpStep2Desc: '有人从板子上接下它，做出来。',
    lpStep3Title: '放上架子',
    lpStep3Desc: '从此以后，谁都能免费用。',
    lpBrowWhy: '为什么这么轻',
    lpWhyTitle: '不用设置，也没什么可失去。',
    lpFeat1Title: '浏览器里直接打开',
    lpFeat1Desc: '不用安装，也不用应用商店。加载过一次之后，关掉网络也照样能用。',
    lpFeat2Title: '数据留在你自己的设备上',
    lpFeat2Desc: '存在你自己的浏览器里。只有想在手机上看到同一份清单时，才需要登录。',
    lpFeat3Title: '一个请求，一个应用',
    lpFeat3Desc: '这里没有一个是凭空想出来的。每个应用都是因为有人开口要过。',
    lpFeat4Title: '每条发布背后都有实名账号',
    lpFeat4Desc: '发请求、评分和留言都需要用 Google 登录。正是这一点让板子上不会堆满垃圾和匿名骚扰。',
    lpBrowShelf: '架子上',
    lpShelfTitle: '随手拿一个，马上就能打开。',
    lpBrowseAll: '查看全部 {count} 个',
    lpBrowOpen: '现在还空着',
    lpOpenTitle: '这些还没有人做。',
    lpOpenLead: '今天挂在板子上的请求。每一个大概花一个晚上就能做出来。',
    lpBuildThis: '我来做',
    lpOpenFine: '认领请求时会用 Google 登录，好让写下它的人知道是谁接手了。',
    lpBrowFaq: '在你开口之前',
    lpFaqTitle: '大家都会问的四个问题。',
    lpFaq1Q: '真的免费吗？',
    lpFaq1A: '是的。没有付费版，没有试用期，也没有以后要加的打算。',
    lpFaq2Q: '需要账号吗？',
    lpFaq2A: '只是浏览、只是使用应用的话不需要。发请求、给应用评分、留言或认领制作时会用 Google 登录——匿名的板子很快会被滥用，而署名可以挡住这件事。',
    lpFaq3Q: '我的数据去哪里了？',
    lpFaq3A: '在你自己的浏览器里。除非你登录并要求在第二台设备上也能看到，否则数据不会离开你的设备。',
    lpFaq4Q: '我也能做一个吗？',
    lpFaq4A: '当然，这正是这里的意义。从板子上挑一个请求，做个小应用，放到架子上。',
    lpBrowTwoWays: '两个入口',
    lpFinalTitle: '一切都始于一件让你觉得烦的小事。',
    lpFinalLead: '不管你在哪一边，第一步都一样。',
    lpLane1Title: '有麻烦事？',
    lpLane1Desc: '用一句话写下来，放到板子上。',
    lpLane1Cta: '写下麻烦',
    lpLane2Title: '晚上有空？',
    lpLane2Desc: '从板子上接一个请求，把它做出来。',
    lpLane2Cta: '查看待做的请求',
    lpFinalFine: '两者都只需要用 Google 登录，此外别无要求。',
    lpRailText: '去板子',
    title: 'CobbleWorks',
    ...
    emailNotifyLabel: '我的需求做成应用时用邮件通知我',
    emailNotifyNote: '发送到你的 Google 账号邮箱。关闭后站内 Inbox 仍然照常显示。',
    save: '保存',
    cancel: '取消',
  ...
  hi: {
    ...
    emailNotifyLabel: 'मेरी रिक्वेस्ट ऐप बनने पर मुझे ईमेल करें',
    emailNotifyNote: 'आपके Google अकाउंट के ईमेल पते पर भेजा जाता है। बंद करने पर भी यहाँ Inbox चलता रहेगा।',
    save: 'सेव करें',
    cancel: 'रद्द करें',
...
// 棚に並んでいるアプリの数。数字が入る文は言語ごとに語順が違うので、
// {count} を含む1文をまるごと差し替える。
// 読み込めていない（0件）ときはHTMLに書いてある数をそのまま使う。初見の人に0を見せないため。
function renderLpAppCount() {
  const big = document.getElementById('lpAppCount');
  if (!big) return; // トップページ以外では何もしない

  const loaded = getApps().length;
  if (loaded > 0) big.textContent = String(loaded);
  const count = loaded > 0 ? loaded : big.textContent;

  const sub = document.getElementById('lpSub');
  if (sub && t.lpSub) sub.textContent = t.lpSub.replace('{count}', count);

  const browseAll = document.getElementById('lpBrowseAll');
  if (browseAll && t.lpBrowseAll) browseAll.textContent = t.lpBrowseAll.replace('{count}', count);
}
