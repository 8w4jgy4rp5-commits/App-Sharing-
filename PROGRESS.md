...
## 2026-09-25 — 短編小説のアイデアをメモ（Bear the Love）

アプリ開発とは別に、朝のランニング中に思いついた短編小説の構想（娘を熊に奪われた父親が、その熊の子熊を育てる話・序章）を `notes/story-ideas/bear-the-love.md` に保存。整理版と原文の両方を残している。
