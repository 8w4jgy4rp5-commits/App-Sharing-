...
- **【第5版・最新】コア＋サテライト構成に** → `docs/research/2026-08-24-core-satellite.md`
  - **これまで全部大型だったのは基準の設計が原因**。「33年連続増配」「世界シェア首位」は
    "すでに勝った会社"しか持てない指標 = **「実績の長さ」を要求したことが大型バイアスの正体**
  - 代償は**時価総額の壁**。信越化学(11.25兆)が3倍→33.75兆=トヨタ級。年6-8%が上限だったのは規模で決まっていた
  - 中小型は別基準(**グローバルニッチトップ + カバレッジの薄さ**)で探した
  - **コア: AEP / 4063信越化学。サテライト: 6368オルガノ(6,072億円・超純水装置世界トップ・カバレッジ2名・目標+56.8%) /
    6363酉島製作所(834億円・海水淡水化ポンプ世界No.1・実績PER10.97で全候補最安・受注残+43.2%)**
  - 見送り: 6254野村マイクロ(カバレッジゼロだが売上-41.6%の急減)
  - **⚠️未解決: 水に寄りすぎ**。サテライト2つとも水で、栗田を残すと水3銘柄。
    電力・電気工事の中小型(PBR1倍割れが多いとの指摘あり)は未着手
  - **妥当性の検証を追加**: ①自社の過去PER ②同業・市場比 ③**益回り vs 国債利回り**の3基準。
    米10年債4.74%/日本10年債2.875%(30年ぶり高値圏)で測ると、
    **AEP(益回り5.24%)と信越化学(5.29%)は妥当、ECL(2.65%)は妥当と言えない** → ECLを格下げ
- 【第4版】ROIC・為替・税制の3視点を追加して再スクリーニング → `docs/research/2026-08-21-screening-v4-roic-fx-tax.md`
  - **4銘柄: 4063信越化学(新規1位) / ECL Ecolab / 6370栗田工業 / AEP**。XYLを除外し日本2・米国2に
  - **①ROIC**: XYLは**ROIC 5.92-6.3%で資本コスト割れ**=「成長すれば価値を破壊する」と指摘あり。
    連続増配15年に目を奪われ資本効率を見ていなかった。ROIC順は信越約15% > ECL13.45% > AEP9.00% > ダイキン7-8% > XYL6%
  - **②為替(最大の見落とし)**: **購買力平価106.91円 vs 実勢159円=約50%の円安乖離**。7月末に日米協調介入。
    10年で130円に戻ればドル建てリターンが約18%削られる → **米国株は一度に買わない・通貨分散**
  - **③税制**: **NISAでは外国税額控除が使えず米国源泉10%を取り返せない** →
    日本株はNISA、配当主目的のAEPは特定口座
  - 新1位の信越化学: ROIC約15%・営業利益率約30%・自己資本比率82.6%・ネットキャッシュ1兆円超・
    ウエハー/塩ビ世界首位・高値から-23.7%・目標+29.6%。**資本効率/財務/堀/通貨がすべて揃う唯一の銘柄**
  - 次点: 6367ダイキン(堀は文句なし・Elliottが3%保有だがROIC7-8%で見送り)
- 【第3版・ガチホールド版】長期保有前提で選び直し → `docs/research/2026-08-21-buy-and-hold-final.md`
  - **4銘柄: ECL Ecolab(33年連続増配・リカーリング90%) / 6370 栗田工業(22期連続増配・超純水世界首位・
    10年契約のストック型でサービス比率84%) / AEP(1910年から462回連続配当) / XYL Xylem(15年連続増配・財務最堅)**
  - **NRG/CEG/TLNを全部撤回**: 3つともIPP=価格受容者ビジネスで長期保有に最も不向き。
    **2017年にNRGのCEO自身が「IPPモデルは時代遅れ」と発言**。**TLNは2022年にChapter 11申請、2023年脱却**の無配企業
  - **自分の誤りの記録**: ECLと栗田を「PERが高い」だけで**3回続けて外していた**。
    短期はPERが効き、長期は「増配を続けられるか」が効く。「安さ」への偏りが一貫した癖
  - テーマ集中が改善(DC依存はAEPのみ)。監視は**年1回・4項目**で足りる
  - **同じ28銘柄が保有期間の前提を変えるだけで3回順位が入れ替わった** →
    銘柄選びより先に「自分の保有期間を決めること」が重要という結論
- 【数年版】保有期間を数年にすると順位がほぼ反転 → `docs/research/2026-08-21-value-shortlist-multiyear.md`
  - **1年版は日本5・米国1 → 数年版は米国4・日本1**。理由: 日本勢は「循環的な追い風」、米国勢は「契約で固定された成長」
  - 数年版5銘柄: **NRG**(2030年まで年14%超・EPS2倍計画・PEG0.79) / **CEG**(年約20%・平均18.5年のPPA) /
    **TLN**(Amazon17年PPA・2028年FCF利回り14%超) / **AEP**(63GWの契約済み負荷・9割がDC・ただしPEG2.12で割高) /
    **1969高砂熱学**(第2フェーズ2027-2030が成長期・中計目標を2回引き上げ)
  - **最大の発見: 九州電力を外す**。ビジョン2035は2026年度1,800億→2030年度1,800億→2035年度2,000億。
    **4年間横ばい計画**で2.5兆円投資。PER5.57倍が安い理由を会社自身が説明していた=バリュートラップ
  - **建設4社を格下げ**: 鹿島のFY2030目標1,500億円をFY2026実績1,773億円が既に超過(大成も同様)。
    会社が数年後の成長を約束していない。ただし配当性向40%+自社株買いは魅力
  - 数年組の急所: **5銘柄すべてがDC需要という単一の根**に繋がる
- **【1年版】バリュー株の最終候補を確定** → `docs/research/2026-08-21-value-shortlist-final.md`
  (読みやすい版: https://claude.ai/code/artifact/77f299e1-a40d-48e1-bc7a-1e03ea930353 )
  - 28銘柄に4段階のふるい(①予想PER15倍以下orPBR1倍割れ ②増益 ③日付と数字が言える触媒 ④上値+15%以上)
  - **最終6銘柄**: NRG(+64.2%) / 1812鹿島(+55.1%) / 1969高砂熱学(+38.0%) /
    1801大成建設(+33.1%) / 1803清水建設(+27.4%) / 9508九州電力(+21.7%)
  - **最大の弱点: 6銘柄中4銘柄が日本の建設に集中**。同じ追い風で動くため実質1つの賭け。建設枠は1〜2に絞るべき
  - 次点: 1980ダイダン(目標株価が未取得)、TLN(TTM赤字。EBITDAは伸びているが**ルールを曲げなかった**)
  - 高砂熱学(1969)が新発見: **1年で株価-0.93%とほぼ動いていないのに利益+35.6%**、受注残4期連続最高
