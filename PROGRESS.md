...
- **【最重要・方針転換】ユーザーの真の目標が判明: 「10年20年で株価が何倍にもなる」銘柄**
  → 教材を作成 `docs/research/2026-08-25-tenbagger-method.md` /
  Artifact: https://claude.ai/code/artifact/22f54013-7bfd-4902-bda2-0d937e1ad4ee
  - **分解式: 株価の倍率 = 売上の倍率 × 利益率の倍率 × PERの倍率 ÷ 株数の倍率**
  - 必要年率: **20年で10倍=12.2%** / 10年で10倍=25.9%(別ゲーム)。時間があれば爆発的成長は不要
  - 4部品のうち**3つ(売上・利益率・株数)は決算書の事実、PERだけ他人の気分**
    → 「①②④が揃った会社をPERがまだ低いうちに買う」のが構造的に有利
  - 実例: **神戸物産は売上2倍で株価60倍**(残り30倍は利益率とPERの変化)、
    **MonotaROは10年100倍超でPERは常に40-60倍** → **高PERは敵ではなく結果**
  - **⚠️自己批判: これまでの基準(低PER・高配当・連続増配・安定)は10倍株の文脈では全部逆のサイン。**
    調査した約30社を「売上年20%成長」で切ると**1社も残らない**(最良のメタウォーター+17.2%、朝日工業社+14.0%)。
    **DC・電力・水は資本集約的で構造的に年20%成長しにくい** = ユーザーのテーマ関心と目標が構造的に衝突
  - 次にやること: この手順で実際にスクリーニング(テーマを外すか維持するかは未決)
- 【前段】冷却水・超純水の中小型10社を洗い出し → `docs/research/2026-08-25-cooling-ultrapure-water-smallcaps.md`
  - 時価総額1兆円未満: 6363酉島(834億) / 9551メタウォーター(1,362億) / **1952新日本空調(1,403億)** /
    6254野村マイクロ(1,395億) / 1979大気社(2,492億) / 1961三機工業(3,673億) / 6005三浦工業(3,694億) /
    1969高砂熱学(5,632億) / 6368オルガノ(6,072億) / 6370栗田工業(8,731億)
  - **重要な区別: A=水そのもの(装置・薬品・ポンプ、ストック型で長期向き) vs B=冷却設備の施工(空調サブコン、
    受注採算次第でストック性低い)**。同じDC冷却でも10年後の姿が違う。ガチホールドならA優先
  - **★最大の発見: 1952 新日本空調** — **PER10.55(予想9.66)で10社最安、配当4.03%で最高**、
    利益+26.4%なのに**1年騰落+0.82%**(高値から-29.9%)。高砂熱学より**PERが5.6pt安く配当が1.1pt高い**。
    ただしBカテゴリなので工事採算の循環である可能性は残る
  - 数字を疑うべき2社: 6254野村マイクロ(実績PER39.43 vs 予想12.10=来期EPS3倍前提、売上-41.6%)、
    6363酉島(予想PER>実績PER=減益織り込み、中東思惑)
  - 荏原(6361)はDC向けチラーポンプの実績ありだが時価総額2.26兆で中小型外
  - **【追補】さらに小型(232億円まで)を追加**: 6378木村化工機(232億) / **6365 DMW電業社機械(236億・PER7.90で全体最安・
    排水処理+海水淡水化)** / 6489前澤工業(303億・**⚠️"inactive"表示で上場状況要確認**) / 1904大成温調(319億・配当3.90%) /
    6247日阪製作所(464億・**日本初のプレート式熱交換器**=液冷の中核部品) / **1975朝日工業社(1,010億・
    売上+14%と利益+48.3%が両方伸びる唯一の銘柄・クリーンルーム+精密温湿度制御でDC明記)** /
    1982日比谷総合設備(1,244億) / 6490日本ピラー工業(2,247億・**半導体洗浄装置向け継手で世界シェア約90%**だが1年+145.9%で走了)
  - 小型はリスクの質が変わる: 流動性/カバレッジゼロ/1社の受注で業績が振れる/存続性の検証が困難
- 【第5版】コア＋サテライト構成に → `docs/research/2026-08-24-core-satellite.md`
